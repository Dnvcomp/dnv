...
class MenusController extends AdminController
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(\Dnv\Menu $menu)
    {
        ...
        $this->content = view(env('DNV').'.admin.menus_create_content')->with(['menu'=>$menu,'type'=>$type,'option'=>$option,'menus'=>$menus,'categories'=>$list,'articles'=>$articles,'filters' => $filters,'portfolios' => $portfolios])->render();
        return $this->renderOutput();
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, \Dnv\Menu $menu)
    {
        //
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(\Dnv\Menu $menu)
    {
