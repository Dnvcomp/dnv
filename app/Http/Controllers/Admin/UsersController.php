...
use Dnv\Http\Requests\UserRequest;
use Dnv\Http\Controllers\Controller;
use Dnv\Repositories\UsersRepository;
...
class UsersController extends AdminController
{
    ...
    public function __construct(RolesRepository $rol_rep, UsersRepository $us_rep )
    {
        ...
        $this->template = env('DNV').'.admin.users';
    }
    ...
    public function index()
    {
        ...
        $this->content = view(env('DNV').'.admin.users_content')->with(['users'=>$users ])->render();
    ...
    public function create()
    {
        ...
        $this->content = view(env('DNV').'.admin.users_create_content')->with('roles',$roles)->render();
        return $this->renderOutput();
    }
    ...
    public function edit(User $user)
    {
        ...
        $this->content = view(env('DNV').'.admin.users_create_content')->with(['roles'=>$roles,'user'=>$user])->render();
        return $this->renderOutput();
    }
